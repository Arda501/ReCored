 ...
 * STARTING -> the ready countdown is running (nobody's teleported yet); aborts back to
 *             WAITING immediately if team sizes stop matching or anyone un-readies
 * RUNNING  -> teams teleported + kitted, cores destructible
